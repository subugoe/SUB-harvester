	...
	*/
	...
	if ($http_response && curl_getinfo($ch, CURLINFO_HTTP_CODE) == 200) {
		...
		if ($oai_identify->isResponseValid()) {
			...
			$content .= "						<td align=\"left\"><input name=\"harvest_period\" id=\"config_harvest\" type=\"text\" size=\"3\" maxlength=\"3\" /> (Tage)</td>\n";
			$content .= "					</tr>\n";
			$content .= "					<tr>";
			$content .= "						<td align=\"right\" valign=\"middle\" class=\"table_field_description\"><label for=\"harvest\">Aktiv:</label></td>\n";
			$content .= "						<td align=\"left\" valign=\"middle\"><input id=\"harvest\" name=\"active\" type=\"checkbox\"/></td>\n";
			$content .= "					</tr>";
			$content .= "					<tr>";
			...
			$content .= "					 </colgroup>\n";
			$content .= "					<tr>\n";
			$content .= "						<td align=\"right\" valign=\"middle\"><input id=\"view_dccreator\" name=\"view_creator\" type=\"checkbox\"/></td>\n";
			$content .= "						<td align=\"left\" valign=\"middle\" class=\"table_field_description\"><label for=\"view_dccreator\">dc:creator</label></td>\n";
			$content .= "						<td align=\"right\" valign=\"middle\"><input id=\"view_dcdate\" name=\"view_date\" type=\"checkbox\"/></td>\n";
			$content .= "						<td align=\"left\" valign=\"middle\" class=\"table_field_description\"><label for=\"view_dcdate\">dc:date</label></td>\n";
			$content .= "						<td></td>\n";
			$content .= "						<td></td>\n";
			$content .= "					</tr>\n";
			$content .= "					<tr>\n";
			$content .= "						<td align=\"right\" valign=\"middle\"><input id=\"view_dccontributor\" name=\"view_contributor\" type=\"checkbox\"/></td>\n";
			$content .= "						<td align=\"left\" valign=\"middle\" class=\"table_field_description\"><label for=\"view_dccontributor\">dc:contributor</label></td>\n";
			$content .= "						<td align=\"right\" valign=\"middle\"><input id=\"view_dcidentifier\" name=\"view_identifier\" type=\"checkbox\"/></td>\n";
			$content .= "						<td align=\"left\" valign=\"middle\" class=\"table_field_description\"><label for=\"view_dcidentifier\">dc:identifier</label></td>\n";
			$content .= "					</tr>\n";
			$content .= "					<tr>\n";
			$content .= "						<td align=\"right\" valign=\"middle\"><input id=\"view_dcpublisher\" name=\"view_publisher\" type=\"checkbox\"/></td>\n";
			...
			$content .= "						<td align=\"left\"><input name=\"identifier_alternative\" id=\"config_alternative\" type=\"text\" size=\"100\" maxlength=\"150\"></input></td>\n";
			$content .= "					</tr>\n";
			$content .= "					<tr>\n";
			$content .= "						<td id=\"label_filter\" align=\"right\" class=\"table_field_description\">Identifier-Filter:</td>\n";
			$content .= "						<td align=\"left\"><input name=\"identifier_filter\" id=\"config_filter\" type=\"text\" size=\"100\" maxlength=\"100\"></input></td>\n";
			$content .= "					</tr>\n";
			$content .= "					<tr>\n";
