	...
	public function __construct($db_link, $status, $type, $limit, $start, $oai_source_id = NULL) {
		...
		if ($total_log_entries == 0) {
			...
			while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
				...
				$this->output .= "					<td style=\"text-align: center;\"><img ".( $row['type'] == 0 ? "src=\"./images/harvester.png\" title=\"Harvester\" alt=\"Harvester\"" : "src=\"./images/indexer.png\" title=\"Indexer\" alt=\"Indexer\"" )."/></td>\n";
